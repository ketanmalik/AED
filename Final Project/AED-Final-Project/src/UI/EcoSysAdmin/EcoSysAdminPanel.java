...
public class EcoSysAdminPanel extends javax.swing.JPanel {
    ...
    public EcoSysAdminPanel(JPanel displayPanel, EcoSystem ecoSystem) {
        initComponents();
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addComponent(labelEnterprise, javax.swing.GroupLayout.Alignment.LEADING))
    ...
    private void viewBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewBtnActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            createdOnTxtField.setText(new SimpleDateFormat("MM/dd/yyyy").format(selectedNetwork.getCreatedOn()));
            lastUpdatedTxtField.setText(new SimpleDateFormat("MM/dd/yyyy").format(selectedNetwork.getLastUpdatedOn()));
