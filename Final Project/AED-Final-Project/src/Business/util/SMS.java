...
public class SMS {
    ...
    public static void sendSMS(String id, int code) {
        Twilio.init(ACCOUNT_SID, AUTH_TOKEN);

        Message message = Message.creator(new PhoneNumber("+18572948824"),
                new PhoneNumber("+18572142194"),
                "Your order number " + id + " is ready for pickup. Pickup code: " + code).create();
